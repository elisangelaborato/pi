...
//    ORDER BY pessoa.nome, pessoa.email, prestador.notaPrestador, pessoa.cdgPessoa
    sql = "SELECT pessoa.nome, pessoa.imagem, pessoa.email, prestador.notaPrestador, pessoa.cdgPessoa FROM pessoa WHERE prestador.ativoPrestador = 1 LEFT JOIN prestador ON prestador.cdgPessoa = pessoa.cdgPessoa ORDER BY pessoa.nome, pessoa.email, prestador.notaPrestador, pessoa.cdgPessoa ";
    else {
