...
class TabAvaliacaoCliente extends StatefulWidget {
  ...
  TabAvaliacaoCliente(this.cdgPessoa_cliente);

  @override
  _TabAvaliacaoClienteState createState() => _TabAvaliacaoClienteState(cdgPessoa_cliente);
}
...
class _TabAvaliacaoClienteState extends State<TabAvaliacaoCliente> {
  ...
  _TabAvaliacaoClienteState(this.cdgPessoa_cliente);
